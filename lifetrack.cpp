...
//Branches are used to construct the flow of the game, which indicate different life stages.
...
//the strings "decision" and "cont" are used to store the turning point choices  and the details of option results after passing each turning point.
    ...
    event *root = new event(decision, cont); 
    ...
    event *branch1 = new event(decision, cont);   
    //Extended plots
    decision = "";
    ...
    event *branch1_1 = new event(decision, cont);
    branch1->events.push_back(branch1_1);
    ...
    cont = "\n";
    event *branch11 = new event(decision, cont);   
    ...
    event *branch11_1 = new event(decision, cont);
    branch11->events.push_back(branch11_1);
    ...
    event *branch111 = new event(decision, cont); 
    branch111->defeat = true;
    ...
    event *branch112 = new event(decision, cont);
    branch112->defeat = true;
    // Branch ended, a short-life but good experience, game over
    
    // End of Branch 1-1-2
    branch112->events.push_back(branch112);
    branch112->events.push_back(branch112);

    // End of branch 1-1
    branch11_1->events.push_back(branch111);
    branch11_1->events.push_back(branch112);
    ...
    event *branch12 = new event(decision, cont);
    branch12->item = 1;
    //Extended plots
    decision = "";
    ...
    event *branch12_1 = new event(decision, cont);
    branch12->events.push_back(branch12_1);
    ...
    event *branch121 = new event(decision, cont);
    branch121->events.push_back(branch121_1);
    ...
    event *branch122 = new event(decision, cont);
    branch12->item = 1;
    //Extended plots
    decision = "";
    ...
    event *branch1221 = new event(decision, cont);
    branch1221->defeat = true;
    ...
    event *branch1222 = new event(decision, cont);
    // Branch ended, great loss
    ...
    branch1221->events.push_back(branch122);
     ...
     // End of branch 1-2-2
    branch122->events.push_back(branch1221);
    branch122->events.push_back(branch1222);

    // End of branch 1-2
    branch12_4->events.push_back(branch121);
    branch12_4->events.push_back(branch122);

    // End of branch 1
    branch1_1->events.push_back(branch11);
    branch1_1->events.push_back(branch12);
    ...
    event *branch2 = new event(decision, cont);
    ...
    event *branch21 = new event(decision, cont);
    ...
    event *branch211 = new event(decision, cont);
    branch2_1_1->events_push_back(branch21);
    ...
    event *branch212 = new event(decision, cont);
    //End of Branch 2-1-2, great loss

    branch2_1_2->events_push_back(branch21);

    //End of branch 2-1
    branch21->events_push_back(branch111);
    branch21->events_push_back(branch222);
    ...
    event *branch22 = new event(decision, cont);
   
    // End of branch 2-2
    branch22->events.push_back(branch111);
    branch22->events.push_back(branch222);

    // End of branch 2
    branch2->events.push_back(branch11);
    branch2->events.push_back(branch22);

    // End of all branchs
    root->events.push_back(branch1);
    root->events.push_back(branch2);
