...
lifetrack *makeTrack(){
    ...
    cont = "This is a time of cyberpunk. The world is full of neon light and telecom devices. You can hear the sound of electromagnetic wave pasing through the big city. And now, you are an infant in this world. As time goes by, it's time to choose your education. The world does not have a systematic educational policy. You are required to choose one style of study. There are two tranding educational styles. One is to go to the multilingual school, so that you could learn multiple subjects within a period of time. However, there are also a branch of people not going to school. Instead, they choose to study in their family, which the nobility prefers.\n";
    ...
    decision = "I am going to the multilingual school.\n";
    ...
    // End of branch 1-1
    branch11->lifetracks.push_back(branch111);
    branch11->lifetracks.push_back(branch112);
    ...
    cont = " I don't want to receive the big fortune without any effort. Life needs to be earned by myself. I have my own entrepreneurial team, why not to start my own business? You and your team starts your own business. At first, everyone in your team plays an important part in their area of study. So the business grows quickly and get a few rounds of investment. However, when thinking about applying for IPO, your team has a second opinion. Someone insists that the business should not be listed so soon since there are many financial indicators that are not steady. You are the CEO of this entity, it's time for you to decide.\n";
